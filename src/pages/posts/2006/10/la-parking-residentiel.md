...
### Le fonctionnement
Une fois que la société nous assure que nous pouvons nous garer dans la zone demandée ([voir carte](/files/2006/OZUID-plattegrond-vergunningen.pdf) (PDF)). Notre immatriculation se retrouve dans leur grand ordinateur. Il n'y a pas de vignette ni de papillon à afficher sur le pare-brise. Les agents verbalisateurs qui circulent dans la ville entrent le numéro de toutes les voitures qu'ils croisent dans un terminal et si le numéro n'est pas dans le grand ordinateur, crack# PV! Une preuve de l'enregistrement dans le grand ordinateur nous est quand même remise et il est conseillé de poser cette feuille visiblement dans la voiture durant la première semaine en cas de délai dans l’enregistrement de l'autorisation.
