...
// Database user
define('DC_DBUSER', 'meinamsterdam');

// Database password
// define('DC_DBPASSWORD', 'apoijTpiHy6h6tFA');
define('DC_DBPASSWORD', 'iQYhpFsf_sWbXDzT');

// Database name
define('DC_DBNAME', 'meinamsterdam');
...
define('DC_MASTER_KEY', '49d0aa3b1cefcb2f38a3c0c4bef995bb');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL', 'https://meinamsterdam.nl/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM', 'dotclear@meinamsterdam.nl');

function _mail($to,$subject,$message,$headers)
{
	socketMail::$smtp_relay = 'localhost';
