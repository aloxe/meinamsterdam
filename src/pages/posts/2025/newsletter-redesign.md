...
Ce faisant, j'ai aussi supprimé la possibilité de suivre les commentaires auxquels quelques personnes étaient abonnées. Je les ai donc inscrites à la solution de newsletter que j'avais mise en place il y a quelque temps.
...
> J'ai enfin trouvé la newsletter idéale, vous ne devinerez jamais laquelle
