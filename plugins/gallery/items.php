...
<head>
  ...
  echo dcPage::jsLoad('index.php?pf=gallery/js/_items_lists.js').
...
echo '<ul class="pseudo-tabs">'.
	...
	'<li><a href="plugin.php?p=gallery&amp;m=items" class="active">'.__('Images').'</a></li>'.
...
echo
	...
	'<div class="cell">'.
	'<h4>'.__('Filters').'</h4>'.
	'<p><label for="gal_id" for="" class="ib">'.__('Gallery:').'</label>'.
	form::combo('gal_id',$gal_combo,$gal_id).'</p>'.
	'<p><label for="media_dir">'.__('Media dir:').'</label>'.
	form::combo('media_dir',$dirs_combo,$media_dir).'</p>'.
	'<p><label for="month" class="ib">'.__('Month:').'</label>'.
	form::combo('month',$dt_m_combo,$month).'</p>'.
	'<p><label for="tag" class="ib">'.__('Tag:').'</label>'.
	form::field('tag',10,100,$tag).'</p>'.
	'</div>'. # cell
